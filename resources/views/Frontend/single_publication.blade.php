            ...
            <div class="col-md-8">
                <div id="page-main">
                    <section id="blog-detail">
                        <center><header><h1>Research Group publication</h1></header></center>
                        <article class="blog-detail">
                            <header class="blog-detail-header">
                                <img src="/storage/img/{{$single_publication->image}}">
                                <br>
                                <h2>{{$single_publication->title}}</h2>
                    ...
                    <aside class="news-small" id="news-small">
                        ...
                        <div class="section-content">
                            ...
                            <article>
                                ...
                                <header><a href="{{$publication->id}}">{{$publication->title}}</a></header>
                            </article><!-- /article -->
                            @endforeach
